...
class _HomepageState extends State<Homepage> {
      ...
      child: Row(
        children: [
          Column(
            ...
            children: [
              Container(height: 120, width: 120, child: Image.asset(image)),
              Text(description),
            ],
          ),
          SizedBox(
  ...
  Widget _weddingavatharcard(
      String description, String image, Widget destinationpage) {
    return InkWell(
      onTap: () {
        Navigator.of(context).push(MaterialPageRoute(
          builder: (context) => destinationpage,
  ...
  Widget _makeupcard(String description, int price, String place, String image,
  ...
  List<Map<String, dynamic>> resorts = [
    {
      "image":
          "assets/Luxury Hotel in Kochi (Cochin) _ Grand Hyatt Kochi Bolgatty.jpg",
      "name": "Grand hyat",
    ...
    {
      "image":
          "assets/Wedding Backdrop Decoration In Bangalore - Flower's By Design.jpg",
        ...
        child: Column(children: [
          SingleChildScrollView(
            ...
            child: Row(
              children: [
                _weddingavatharcard(
                    'Wedding venues',
                    'assets/bdb2b3175179ba0534979f0608f8997c.jpg',
                    Weddingvenues()),
                _weddingavatharcard(
                    'Bridal makeup',
                    'assets/Beautiful Hindu Bride _ Kerala Bride _ Kerala Bridal Makeup _ Hindu Wedding Makeup _ Red Silk Saree.jpg',
                    Makeup()),
                _weddingavatharcard(
                    'wedding photographers',
                    'assets/28 Picture Perfect Wedding Poses For Indian Couples To Try - Eternity.jpg',
                    Photographers()),
                _weddingavatharcard(
                    'Wedding decorators',
                    'assets/b9728feb984a20de9c4d2ed1efa9cde2.jpg',
                    Decorations())
              ],
            ),
          ),
          ...
          SizedBox(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return _makeupcard('Lintas beauty parlour', 15000, 'Trissur',
                      'assets/f1a820c4a3ca897fb4556625258d1baa.jpg', Makeup());
                },
              )),
          SizedBox(height: 30),
          Row(
